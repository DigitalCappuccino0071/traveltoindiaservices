...
export default function StepTwo() {
  ...
  useEffect(() => {
    ...
    } else if (formId && formData?.step2Data) {
      router.push('/visa/step-two/update');
    }
  }, [formId, formData?.step1Data, formData?.step2Data, router]);
  ...
  if (formId && (formData?.step1Data?.paid || formData?.step2Data)) {
    return <LoadingSkeleton />;
  }
