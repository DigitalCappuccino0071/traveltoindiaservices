      ...
      <Formik
        ...
        onSubmit={async (values, { setSubmitting, resetForm }) => {
          ...
          try {
            ...
            formData.append('profilePicture', uploadedPublicIds.profilePicture);
              ...
              <div className="bg-white shadow-md rounded-lg p-6 mb-8">
                ...
                <div className="p-4 bg-blue-50 rounded-md mb-6 border border-blue-200">
                  ...
                  <p>
                    ...
                    button. You can resume your application using the "Complete
                    Partially Filled Form" option on the home page.
                  </p>
                </div>
                    ...
                    <div className="flex items-center mb-2">
                      ...
                      {uploadedPublicIds.passport.length > 0 && (
                        <span className="ml-2 text-green-500 flex items-center text-sm">
                          ...
                          <span>
                            {uploadedPublicIds.passport.length} file(s) uploaded
                          </span>
                        </span>
                      )}
                    </div>
