...
export default function StepOne() {
  ...
  // If we have form data and step1 is completed, redirect to update page
  if (formData?.step1Data && state.steps.step1) {
                              ...
                              <div className="px-4 py-2 space-y-2">
                                ...
                                <div className="flex items-start space-x-2">
                                  ...
                                  <label htmlFor="eTouristVisa30DaysValue4">
                                    ...
                                    MEDICINE ETC. WHICH SHOULD NOT BE A FORMAL
                                    OR STRUCTURED COURSE/PROGRAMME (COURSES NOT
                                    EXCEEDING 6 MONTHS DURATION AND NOT ISSUED
                                    WITH A QUALIFYING CERTIFICATE/ DIPLOMA ETC)
                                  </label>
                                </div>
                                <div className="flex items-start space-x-2">
                                  <Field
                                  ...
                                  <label htmlFor="eTouristVisa30DaysValue5">
                                    VOLUNTARY WORK OF SHORT DURATION (FOR A
                                    MAXIMUM PERIOD OF ONE MONTH, WHICH DO NOT
                                    INVOLVE ANY MONETARY PAYMENT OR
