...
export const step5ValidationSchema = {
  yupSchema: Yup.object().shape({
    haveYouBeenArrested: Yup.string(),
    haveYouBeenArrestedInput: Yup.string().when('haveYouBeenArrested', {
      is: 'yes',
  ...
  initialValues: {
    haveYouBeenArrested: 'no',
    haveYouBeenRefusedEntry: 'no',
    haveYouBeenEngagedInTrafficking: 'no',
    haveYouBeenEngagedInCrime: 'no',
    haveYouExpressedViews: 'no',
    haveYouSoughtAsylum: 'no',
    declaration: false,
...
export const step5data = [
  {
    ...
    inputName: 'haveYouBeenArrestedInput',
  },
  {
    id: 2,
    question:
    ...
    inputName: 'haveYouBeenRefusedEntryInput',
  },
  {
    id: 3,
    question:
    ...
    inputName: 'haveYouBeenEngagedInTraffickingInput',
  },
  {
    id: 4,
    question:
    ...
    inputName: 'haveYouBeenEngagedInCrimeInput',
  },
  {
    id: 5,
    question:
    ...
    inputName: 'haveYouExpressedViewsInput',
  },
  {
    id: 6,
    question:
    ...
    inputName: 'haveYouSoughtAsylumInput',
  },
];
